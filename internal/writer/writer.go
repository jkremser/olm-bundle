...
func (b *Bundle) writeDockerfile(path string) error {
	...
	return ioutil.WriteFile(path, []byte(out), os.FileMode(0o664))
}
...
func (b *Bundle) writeManifests(dir string) error {
	...
	for _, m := range b.Manifests {
		...
		if err = ioutil.WriteFile(filepath.Join(dir, name), o, os.FileMode(0o664)); err != nil {
...
func (b *Bundle) writeAnnotations(dir string) error {
	...
	return ioutil.WriteFile(annotationsPath, out, os.FileMode(0o664))
}
